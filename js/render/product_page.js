function openSanPhamPage() {
  ...
  // '    <a href="?product?Apple&1" class="item" data-brand="Apple"><img src="Picture/apple-laptop-logo.webp" /></a>'+
  // '    <a href="?product?Asus&1" class="item" data-brand="Asus"><img src="Picture/asus-laptop-logo.webp" /></a>'+
  // '    <a href="?product?Dell&1" class="item" data-brand="Dell"><img src="Picture/dell-laptop-logo.webp" /></a>'+
  // '    <a href="?product?HP&1" class="item" data-brand="HP"><img src="Picture/hp-laptop-logo.webp" /></a>'+
  // '    <a href="?product?Lenovo&1" class="item" data-brand="Lenovo"><img src="Picture/lenovo-laptop-logo.webp" /></a>'+
  // '    <a href="?product?Acer&1" class="item" data-brand="Acer"><img src="Picture/acer-laptop-logo.webp" /></a>'+
  // '    <a href="?product?MSI&1" class="item" data-brand="MSI"><img src="Picture/msi-laptop-logo.webp" /></a>'+
  // '  </div>'+
  let str =
    '<div class="filter">' +
    ...
    // '    <div class="dropdown">' + 
    // '     <div class="desc">Sắp xếp</div>'+
    // '     <div class="dropdown-content">' +
    // '       <div class="item">Mặc định</div>' +
    // '       <div class="item">Tăng dần</div>' +
    // '       <div class="item">Giảm dần</div>' +
    // '     </div>' +
    // '    </div>' + 
    "</div>" +
    '  <div class="headline">' +
