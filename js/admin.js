...
function UserInfo(tenNguoiDung, diaChi, email, soDienThoai)
{
...
function showListDonHang(dateFrom, dateTo)
{
    ...
    for (let i = listDonHang.length - 1; i >= 0; i--) {
        ...
        if(dateFrom == undefined || (date >= dateFrom && date <= dateTo) || isEqualDate(date, dateFrom) || isEqualDate(date, dateTo))
        {
...
function showListThongKe(dateFrom, dateTo, brand)
{
    ...
    '  <div class="anhthongke" ><img src="Picture/5031661.png" width="500" height="250" alt="" /></div>' +
